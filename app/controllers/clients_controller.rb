class ClientsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @client.save
        ...
        flash.now[:danger] = "There was a problem creating the client."
  ...
  def update
    respond_to do |format|
      if @client.update(client_params)
        ...
        flash.now[:danger] = "There was a problem updating the client."
  ...
  private
    ...
    def client_params
      params.require(:client).permit(:name, :phone, :address_line_1, :address_line_2, :city, :state, :country, :zipcode)
    end
end
