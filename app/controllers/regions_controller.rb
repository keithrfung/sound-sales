class RegionsController < ApplicationController
  ...
  def destroy
    @region.destroy
    respond_to do |format|
      format.html { redirect_to regions_url, success: 'Region was successfully destroyed.' }
  ...
  private
    ...
    def region_params
      params.require(:region).permit(:name, :area, :city, :state, :zipcode, :country, :manager_id)
    end
end
